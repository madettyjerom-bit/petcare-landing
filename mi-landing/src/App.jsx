...
export default function App() {
  ...
  return (
    <div className="d-flex flex-column min-vh-100 bg-light text-dark pt-5">
      <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed-top shadow">
        <div className="container">
          <a className="navbar-brand fw-bold text-success" href="#">PetCare 🐾</a>
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto align-items-center">
              ...
              <li className="nav-item ms-2">
                <a className="btn btn-success btn-sm fw-bold px-3 rounded-pill text-white" href="#newsletter">Descargar App</a>
              </li>
            </ul>
          </div>
        </div>
